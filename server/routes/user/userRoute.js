...
const { profilePhotoResize } = require('../../middlewars/uploading/photoResize')
...
userRouter.put('/profilephoto-upload', authMiddleware, photoUpload.single("image"), profilePhotoResize, uploadProfilePhoto)
